...
public class TrustData {
    ...
    public TrustData(SAMLProperties samlProperties) {
	this.cfg = samlProperties;
    }
	...
	String keystorePath = cfg.getKeyStorePath();
	String keystorePW = cfg.getKeyStorePassword();
	String keyName = cfg.getKeyStoreAlias();
	String ksType = cfg.getKeyStoreType();
	...
	String samlIssuer = cfg.getSamlIssuer();
	return samlIssuer;
    }
